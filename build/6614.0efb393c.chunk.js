"use strict";(self.webpackChunknews_auth=self.webpackChunknews_auth||[]).push([[6614],{26614:(V,T,t)=>{t.d(T,{ProtectedListPage:()=>ct});var s=t(19968),c=t(62552),f=t(3400),M=t(20596),C=t(48112),b=t(28464),W=t(52051),g=t(63358),i=t(35676),o=t(42816),h=t(5e3),d=t(42848),x=t(89616),p=t(20464),D=t(76512),l=t(9752),O=t(19576),_=t(35480),tt=t(48744),A=t(48936),Z=t(69372);const k=Z.default.div`
...
`,g=(0,c.default)(f.k)`
  ...
  width: 100%;
  border: none;
`,i=({children:o,icon:h,...d})=>(0,s.jsxs)("div",{children:[(0,s.jsx)(M.c,{}),(0,s.jsx)(g,{as:"button",background:"primary100",padding:5,...d,children:(0,s.jsxs)(C.C,{children:[(0,s.jsx)(W,{"aria-hidden":!0,background:"primary200",children:h}),(0,s.jsx)(f.k,{paddingLeft:3,children:(0,s.jsx)(b.O,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:o})})]})})]})}}]);
